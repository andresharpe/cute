...
{
    private readonly GenerateBulkAction _generateCommandRunner = generateCommandRunner;
    ...
    public override async Task<int> ExecuteCommandAsync(CommandContext context, Settings settings)
    {
        ...
        await ProgressBars.Instance().StartAsync(async ctx =>
        {
            ...
            await _generateCommandRunner.GenerateContent(settings.Key,
                displayActions,
                (step, steps) =>
                {
